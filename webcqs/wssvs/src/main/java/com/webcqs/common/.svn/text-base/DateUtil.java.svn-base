...
public class DateUtil {
	...
	public static String formart8 = "yyyyMMddHHmmss";
	private static String formart9="yyyy年MM月"; 
	public static String formart10="yyyy-MM-dd HH:mm:ss"; 
	 ...
	 * @return
	 */
	public static String data2localStr(Date d){
		if(d==null)return null;
		SimpleDateFormat sdf = new SimpleDateFormat(formart9);
		return sdf.format(d);
	}
	...
	public static Date getDateFromStr( String _sDateStr)
			throws Exception {
		if (_sDateStr == null)
			throw new Exception("待转换的时间不能为空");
		if(_sDateStr.length()<=10)return getDateFromStr(formart3,_sDateStr);
		SimpleDateFormat sdf = new SimpleDateFormat(formart10);
		return sdf.parse(_sDateStr);
	}
	/**
	 * 当前年份
